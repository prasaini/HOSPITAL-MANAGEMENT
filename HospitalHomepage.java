...
public class HospitalHomepage extends JFrame implements ActionListener {
    ...
    public HospitalHomepage() {
        ...
        addressLabel = new JLabel("Karol Bagh, New Delhi");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == aboutBtn) {
            JOptionPane.showMessageDialog(this, "Hello i am a world class hospital here to serve you in your medical needs");
